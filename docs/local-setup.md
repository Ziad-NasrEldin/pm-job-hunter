# PM Job Hunter local setup

Product overview is in the root [README](../README.md). This page is the previous engineer runbook: Windows EXE, installer, CLI, API, and storage layout.
